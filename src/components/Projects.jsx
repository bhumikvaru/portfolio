...
const Projects = () => {
  ...
  //       description:
  //         "A revamped iteration cross-platform website of my portfolio website, built in 2021. Designed and develop with an analytical approach and thinking process to avoid using any frameworks that lack in depth such as Bootstrap.",
  //       image: project7,
  ...
  //       description:
  //         "A security Dashboard that I made for my Web Development Module. It's a single page web application, which displays data about how many users connect to the systems, system statuses and health, security alerts and system alerts.",
  //       image: project1,
  ...
  //       subtitle: "C#",
  //       description:
  //         "A C# Command line Dungeon Crawler that I made for my Software Engineering Module. It's a game where the player is in a maze surrounded by monsters and they need to get to the exit, they can pick up gold and kill monsters to get extra points.",
  //       image: project2,
  ...
  //       subtitle: "HTML, CSS, JavaScript and Firebase",
  //       description:
  //         "A responsive website that displays the information and work of the Plymouth based music band, Eyes of Caelum",
  //       image: project3,
  ...
  //       subtitle: "C#",
  //       description:
  //         "A C# Console Mastermind Code-Breaker that I made for my Data and Algorithms Module. It's a game where the computer generates a code up to 9 digits long with numbers varing from 1-4 to 1-9 and the user has up to 20 guesses to guess the correct code",
  //       image: project4,
  ...
  //       description:
  //         "A rebranded cross-platform website for the South Hams Society that will make a difference and inspire locals to save the environment around them and preserve it for the future generations",
  //       image: project5,
  ...
  //       description:
  //         "My first portfolio website I designed and built in 2020. I learned quite a bit about HTML, CSS, and JavaScript. Since then, I think my web development and design skills have improved immensely.",
  //       image: project8,
  ...
  return (
    <div
      ...
      name="work"
      className="w-full md:h-full text-black z-10"
    >
      <div
        data-aos="fade-up"
      ...
      >
        <div className="pb-8">
          <p
            id="title"
            className="text-4xl font-bold inline border-b-4 border-black"
          >
            My Projects
          </p>
